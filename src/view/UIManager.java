...
import manager.DesignModifiers;
...
public class UIManager extends JPanel{
    ...
    public UIManager(GameEngine engine, int width, int height) {
        ...
        DesignModifiers mod = DesignModifiers.getInstance();
        
        BufferedImage sprite = loader.loadImage(mod.sSprite);
        this.heartIcon = loader.loadImage(mod.heart);
        this.coinIcon = loader.getSubImage(sprite, 1, 5, 48, 48);
        this.selectIcon = loader.loadImage(mod.icon);
        this.startScreenImage = loader.loadImage(mod.menu);
        this.helpScreenImage = loader.loadImage("/help-screen.png");
        this.aboutScreenImage = loader.loadImage("/about-screen.png");
        this.gameOverScreen = loader.loadImage(mod.gameOver);
